...
public class Player : MonoBehaviour
{
    ...
    private void Start()
    {
        transform.position = GameManager.Instance._playerPosition;
        transform.rotation = GameManager.Instance._playerRotation;
    }
    ...
    {
        GameManager.Instance._playerPosition = transform.position;
        GameManager.Instance._playerRotation = transform.rotation;
    }
}
